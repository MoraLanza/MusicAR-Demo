...
const updateNewPasswordValidationMiddleware = require('../middlewares/updateNewPasswordValidationMiddleware');
...
router.put('/profile/updatePass/:id', updateNewPasswordValidationMiddleware, userController.updatePassword);
